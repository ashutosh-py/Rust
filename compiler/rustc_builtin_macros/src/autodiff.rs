...
use rustc_ast::Safety::Unsafe;
use rustc_ast::{
    self as ast, AssocItemKind, BindingMode, ByRef, Fn, FnHeader, FnRetTy, FnSig, Generics,
...
fn gen_enzyme_body(
    ...
    let noop = ast::InlineAsm {
        template: vec![ast::InlineAsmTemplatePiece::String("NOP".into())], //to_string().

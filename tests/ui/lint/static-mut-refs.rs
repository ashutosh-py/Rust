...
fn main() {
    ...
    unsafe {
        ...
        let _ = Z[0];
        //[e2021]~^ WARN creating a reference to mutable static is discouraged [static_mut_refs]
        //[e2024]~^^ ERROR creating a reference to mutable static is discouraged [static_mut_refs]
        let _ = format!("{:?}", Z);
        //[e2021]~^ WARN creating a shared reference to mutable static is discouraged [static_mut_refs]
        //[e2024]~^^ ERROR creating a shared reference to mutable static is discouraged [static_mut_refs]
